...
import '../viewsmodels/Ascimodel.dart';

class Asci extends StatefulWidget {
  ...
  @override
  State<Asci> createState() => _AsciState();
}

class _AsciState extends State<Asci> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<Ascimodel>(
      create: (_) => Ascimodel(),
      builder: (context, child) => Scaffold(
        backgroundColor: Colors.blueGrey[300],
        appBar: AppBar(
          title: Text('Yemek Siparişleri'),
          toolbarHeight: 80,
          ...
          child: Column(
            children: [
              StreamBuilder<List<Siparis>>(
                stream: Provider.of<Ascimodel>(context, listen: false)
                      ...
                      children: [
                        SlidableAction(
                          onPressed: (BuildContext context) async {
                            await Provider.of<Ascimodel>(context,
                                listen: false)
